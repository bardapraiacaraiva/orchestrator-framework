...
async function init(args) {
  ...
  if (!licenseKey) {
    ...
    console.log('\n  Get your key at: \x1b[36mhttps://automationsolutionai.com/orchestrator\x1b[0m');
  ...
  if (!licenseKey) {
    error('License key required. Get your key at: https://automationsolutionai.com/orchestrator');
